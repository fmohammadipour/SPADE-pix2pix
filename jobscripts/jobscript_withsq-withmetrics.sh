...
python -u trainwithmetrics.py --name DRV47_withSQ_withmetrics --dataset_mode pix2pix --dataroot datasets/DRV47/Withsq/train/ --no_instance --label_nc 0 --batchSize 1
